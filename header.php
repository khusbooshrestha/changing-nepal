...
<head>
  ...
  <!-- Google fonts -->
  <link href="https://fonts.googleapis.com/css?family=Lato:400,700,900&display=swap" rel="stylesheet"> <!-- Bootstrap CSS -->
  <link rel="stylesheet" href="css/bootstrap.min.css">
  <link rel="stylesheet" href="fontawesome-new/css/all.css">
          ...
          <nav class="navbar navbar-expand-md scrolling-navbar ">
            ...
            <div class="collapse navbar-collapse " id="main-navbar">
              <ul class="navbar-nav ">
                ...
                <li class="nav-item ">
                  <a class="nav-link " href="service-archive.php">
                    services
                  </a>
